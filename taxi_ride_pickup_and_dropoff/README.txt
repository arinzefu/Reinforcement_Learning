I apologize for not uploading the best model but after a few days of training and adjusting the parameters,
the best mean episode result  i could get was -20 result but I did not save that model, eventually I got tired of training,
adjusting the learning rate and increasing the timesteps is recommended along with changing some of the other parameters.
